...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public BaseResult errorHandle(RuntimeException myException) {
        return BaseResult.failed(400, myException.getMessage());
    }
    ...
    public BaseResult errorHandler(Exception exception) {
        return BaseResult.failed(500, exception.getMessage());
    }
}
